...
The system to be tested for this part is a hypothetical system and its failure data will be distributed via the GitHub. There will be a few test data files and the students should select one of them.

## 2.4 FAMILIARIZATION

### 2.4.1 INSTALL CASRE

1.  Get the CASRE30.exe (self-extracting archive) and its manual CASRE3UG.pdf from GitHub.

2.  Get the CASRE-DOSBOX.zip from GitHub.
...
### 2.4.2 Alternatively: INSTALL STRAT

1.  Get SRTAT-SRE-tool.zip from GitHub.
...
### 2.5.1 Running CASRE (Computer-Aided Software Reliability Estimation)
...
### 2.5.2 Running SRTAT (Software Reliability and Testing Analysis)
...
1.  Get Reliability-Demonstration-Chart.xls and its manual RDC-xls-Overview.pdf from GitHub.

1.  Open the excel sheet and verify that it works by setting various risk factors, i.e. check whether the right chart will be generated.

1.  Read the document explaining its functionality.

1.  If you are running 64-bit Windows operating system, install the CASRE-DOSBOX and then install and run CASRE.

![Picture1](media/a17167c26c1c8fe6dd5b4136561fb660.png)

### 3.4.2 Alternatively: INSTALL STRAT (as in 1.4.2, RDC is included in SRTAT tool as an option tab)

1.  Get SRTAT-SRE-tool.zip from GitHub.

1.  It is a Java package that has 4 variations for different operating systems. Install the appropriate version on your system.
...
Students will be required to submit a report on their work in the lab as a group. To be consistent, please use the template file “Assignment5-ReportTemplate.md” provided online under the Assignment 5 folder. If desired, feel free to rename the sections, as long as the headings are still descriptive and accurate.
